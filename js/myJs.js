...
$('#yes').click(function() {
    ...
    Swal.fire({
        ...
        width: 900,
        padding: '3em',
        html: "<input type='text' class='form-control' id='txtReason' onmousemove=textGenerate()  placeholder='ừ bấm đi'>",
        background: '#fff url("../img/iput-bg.jpg")',
        backdrop: `
              rgba(0,0,123,0.4)
              url("../img/giphy2.gif")
        ...
        if (result.value) {
            Swal.fire({
                ...
                background: '#fff url("../img/iput-bg.jpg")',
                title: 'cút',
                text: "đừng đú trend tiktok nữa làm ơn",
